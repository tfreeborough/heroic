/**
 * OpenAI calls: gpt-image-1 image generation. (The chat prompt expander that
 * lived here was retired 2026-09-06 — the sound briefs are written in the
 * local Stable Audio engine's own register and go out verbatim.)
 */
