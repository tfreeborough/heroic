...
const STATIC: ReadonlyArray<{ id: string; label: string; category: SoundCategory }> = [
  ...
  { id: "sands_close", label: "The Blood Tide rises — the circle rolls", category: "flow" },
  ...
  { id: "arm_clock_tick", label: "Ranked — arm clock tick (last 5s to pick)", category: "flow" },
  ...
  { id: "signet_exchange", label: "Armory — the forge STRIKE (Signet struck)", category: "flow" },
  { id: "signet_unlock", label: "Armory — seal break (item unlocked)", category: "flow" },
  { id: "signet_purchase", label: "Armory — Signet pack banked (IAP credit)", category: "flow" },
  // UI
