...
export const DEED_ICONS: Record<string, number | null> = {
  ...
  "deed-tide-horn": require("../../assets/deeds/deed-tide-horn.png"),
  "deed-tide-kills": require("../../assets/deeds/deed-tide-kills.png"),
  "deed-baptism": require("../../assets/deeds/deed-baptism.png"),
  "deed-waist-deep": require("../../assets/deeds/deed-waist-deep.png"),
  "deed-tide-decided": require("../../assets/deeds/deed-tide-decided.png"),
  "deed-quicksand": require("../../assets/deeds/deed-quicksand.png"),
  "deed-last-grain": require("../../assets/deeds/deed-last-grain.png"),
  "deed-undertow": require("../../assets/deeds/deed-undertow.png"),
  "deed-dry-feet": require("../../assets/deeds/deed-dry-feet.png"),
  "deed-taken-by-tide": require("../../assets/deeds/deed-taken-by-tide.png"),
  "deed-sand-fall": require("../../assets/deeds/deed-sand-fall.png"),
  "deed-tidecaller": require("../../assets/deeds/deed-tidecaller.png"),
  ...
  "deed-well-met": require("../../assets/deeds/deed-well-met.png"),
  "deed-regulars": require("../../assets/deeds/deed-regulars.png"),
  "deed-both-sides": require("../../assets/deeds/deed-both-sides.png"),
  "deed-grudge": require("../../assets/deeds/deed-grudge.png"),
  "deed-one-more": require("../../assets/deeds/deed-one-more.png"),
  "deed-closed-doors": require("../../assets/deeds/deed-closed-doors.png"),
  "deed-open-house": require("../../assets/deeds/deed-open-house.png"),
  "deed-full-house": require("../../assets/deeds/deed-full-house.png"),
  "deed-six-enter": require("../../assets/deeds/deed-six-enter.png"),
  "deed-one-leaves": require("../../assets/deeds/deed-one-leaves.png"),
  "deed-six-strangers": require("../../assets/deeds/deed-six-strangers.png"),
  "deed-clean-house": require("../../assets/deeds/deed-clean-house.png"),
  "deed-vulture": require("../../assets/deeds/deed-vulture.png"),
  "deed-untouchable": require("../../assets/deeds/deed-untouchable.png"),
  "deed-not-today": require("../../assets/deeds/deed-not-today.png"),
  "deed-bridesmaid": require("../../assets/deeds/deed-bridesmaid.png"),
  "deed-doppelganger": require("../../assets/deeds/deed-doppelganger.png"),
  "deed-uniform": require("../../assets/deeds/deed-uniform.png"),
  "deed-full-set": require("../../assets/deeds/deed-full-set.png"),
